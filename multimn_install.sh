...
echo -e "\n====================================================================================\
         ...
         \n   ${GRAY}██║ ╚═╝ ██║ ╚██████╔╝ ██████╗   ██║    ██████╗ ${NC}██║ ╚═╝ ██║██║ ╚████║  \
         \n   ${GRAY}╚═╝     ╚═╝  ╚═════╝  ╚═════╝   ╚═╝    ╚═════╝ ${NC}╚═╝     ╚═╝╚═╝  ╚═══╝  \
         \n                                ╗ made by ${GREEN}ENZO${NC} ╔\
         \n                   Credit: ${YELLOW}Credit for this script to neo3587${NC}\
         \n           Source: ${CYAN}https://github.com/EnzoNodes/ENZO-MN${NC}\		 
         \n====================================================================================\
         \n                                                   "

multimn_update=$(curl -s https://raw.githubusercontent.com/EnzoNodes/ENZO-MultiMN/main/multimn.sh)
